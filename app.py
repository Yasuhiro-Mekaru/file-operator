...
def hello():
	...
	# 1つ目のカメラ画像
	operate_1 = operate_file.Operate_file(picture_path=configure.picture_path_1, temp_path=configure.temp_path_1,
										original_picture_path=configure.original_picture_path_1, renamed_picture_path=configure.renamed_picture_path_1)
	operate_lists.append(operate_1)
	# 2つ目のカメラ画像
	operate_2 = operate_file.Operate_file(picture_path=configure.picture_path_2, temp_path=configure.temp_path_2,
										original_picture_path=configure.original_picture_path_2, renamed_picture_path=configure.renamed_picture_path_2)
	operate_lists.append(operate_2)
	# 3つ目のカメラ画像
	operate_3 = operate_file.Operate_file(picture_path=configure.picture_path_3, temp_path=configure.temp_path_3,
										original_picture_path=configure.original_picture_path_3, renamed_picture_path=configure.renamed_picture_path_3)
	operate_lists.append(operate_3)


	pic_lists = []
	# 新規の画像ファイルが送信されているか確認
	pic_list_1 = operate_1.get_pictures(path=configure.picture_path_1)
	pic_lists.append(pic_list_1)

	pic_list_2 = operate_2.get_pictures(path=configure.picture_path_2)
	pic_lists.append(pic_list_2)

	pic_list_3 = operate_3.get_pictures(path=configure.picture_path_3)
	pic_lists.append(pic_list_3)

	temp_path_lists = [configure.temp_path_1, configure.temp_path_2, configure.temp_path_3]
	...
	return render_template('display.html', picture_infos=picture_infos)
